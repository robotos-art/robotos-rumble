...
export function UnitFilters({ onFiltersChange, unitCount, filteredCount }: UnitFiltersProps) {
  ...
  const hasActiveFilters = filters.search || filters.elements.length > 0 || filters.robotType !== 'all' ||
    filters.minHp || filters.maxHp || filters.minAttack || filters.maxAttack ||
    filters.minDefense || filters.maxDefense || filters.minSpeed || filters.maxSpeed
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <Input
                  ...
                  placeholder="Min"
                  value={filters.minHp || ''}
                  onChange={(e) => updateFilters({ minHp: e.target.value ? Number(e.target.value) : undefined })}
                ...
                <Input
                  ...
                  placeholder="Max"
                  value={filters.maxHp || ''}
                  onChange={(e) => updateFilters({ maxHp: e.target.value ? Number(e.target.value) : undefined })}
                  className="bg-black/60 border-green-500/30 text-green-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <Input
                  ...
                  onChange={(e) => updateFilters({ minAttack: e.target.value ? Number(e.target.value) : undefined })}
                  className="bg-black/60 border-green-500/30 text-green-500"
                />
                <span className="text-green-500 self-center">-</span>
                <Input
                  ...
                  onChange={(e) => updateFilters({ maxAttack: e.target.value ? Number(e.target.value) : undefined })}
                  className="bg-black/60 border-green-500/30 text-green-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <Input
                  ...
                  onChange={(e) => updateFilters({ minDefense: e.target.value ? Number(e.target.value) : undefined })}
                  className="bg-black/60 border-green-500/30 text-green-500"
                />
                <span className="text-green-500 self-center">-</span>
                <Input
                  ...
                  onChange={(e) => updateFilters({ maxDefense: e.target.value ? Number(e.target.value) : undefined })}
                  className="bg-black/60 border-green-500/30 text-green-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <Input
                  ...
                  onChange={(e) => updateFilters({ minSpeed: e.target.value ? Number(e.target.value) : undefined })}
                  className="bg-black/60 border-green-500/30 text-green-500"
                />
                <span className="text-green-500 self-center">-</span>
                <Input
                  ...
                  onChange={(e) => updateFilters({ maxSpeed: e.target.value ? Number(e.target.value) : undefined })}
                  className="bg-black/60 border-green-500/30 text-green-500"
                />
              </div>
            </div>
